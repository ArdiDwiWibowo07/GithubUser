package com.ardidwibowo.githubuser.alarm.Receiver
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    private fun sendNotification(context: Context){
        val intent = context?.packageManager.getLaunchIntentForPackage("com.ardidwibowo.github")
    ...
    fun setRepeatAlarm(context: Context, type : String, time: String, message : String) {
        ...
        Toast.makeText(context, "Repeating alarm set up 06:00", Toast.LENGTH_SHORT).show()
    }
    ...
    fun cancelAlarm(context: Context){
        ...
        val pendingIntent = PendingIntent.getBroadcast(context, requestCode, intent,  if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) PendingIntent.FLAG_IMMUTABLE else 0)
